...
| `figs/` | **strongly recommended** | PNG visualizations referenced from the README. Class distribution and capture-condition heatmaps are what readers scan first when assessing a dataset; their absence makes the catalog page much harder to evaluate. See the [annotated_chemopad worked example](https://github.com/PaperAnalyticalDeviceND/annotated_chemopad/blob/main/scripts/build_registry_plots.py) for a template that emits four standard plots |
