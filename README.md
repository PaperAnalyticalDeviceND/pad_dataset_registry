...
For the full step-by-step procedure see [How to add a dataset](docs/how-to-add-a-dataset.md), also published at <https://padproject.info/pad_dataset_registry/how-to-add-a-dataset.html>. Quick summary:
